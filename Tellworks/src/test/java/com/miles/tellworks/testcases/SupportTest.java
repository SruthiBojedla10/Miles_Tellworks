...
public class SupportTest extends TellworksBase {
	...
	@Test(priority=13)
	public void SupportInventoryValidationTest() throws InterruptedException {
		extentTest = extent.startTest("SupportInventoryValidationTest");
		Assert.assertTrue(support.SupportInventoryValidation());
	}
